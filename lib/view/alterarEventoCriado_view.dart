...
class AlterarEventoCriadoView extends StatefulWidget {
  const AlterarEventoCriadoView({super.key});

  @override
  State<AlterarEventoCriadoView> createState() =>
      _AlterarEventoCriadoViewState();
}

class _AlterarEventoCriadoViewState extends State<AlterarEventoCriadoView> {
            ...
            OutlinedButton(
              ...
              onPressed: () {
                if (!areCamposPreenchidos()) {
                  ...
                  mostrarSnackBar('Evento alterado');
