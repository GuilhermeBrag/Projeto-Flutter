...
class ParticiparEventosView extends StatefulWidget {
  const ParticiparEventosView({super.key});

  @override
  State<ParticiparEventosView> createState() => _ParticiparEventosViewState();
}

class _ParticiparEventosViewState extends State<ParticiparEventosView> {
            ...
            OutlinedButton(
              ...
              onPressed: () {
                if (!areCamposPreenchidos()) {
                  ...
                  mostrarSnackBar('Agora voce está participando desse evento');
